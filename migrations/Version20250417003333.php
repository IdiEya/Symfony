 ...
 */
final class Version20250417003333 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE coach (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, photo VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, speciality VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE achat_produit (utilisateur_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_C26FA378FB88E14F (utilisateur_id), INDEX IDX_C26FA378F347EFB (produit_id), PRIMARY KEY(utilisateur_id, produit_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE abonnement CHANGE mode_paiement mode_paiement VARCHAR(255) NOT NULL, CHANGE sportif_id sportif_id INT DEFAULT NULL, CHANGE gym_id gym_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE cours ADD places_disponibles INT DEFAULT NULL, DROP coach_id, DROP responsableSalle_id, DROP salleId, DROP placesDisponibles, CHANGE date_fin date_fin DATETIME NOT NULL, CHANGE description description LONGTEXT DEFAULT NULL, CHANGE prix prix NUMERIC(10, 2) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE abonnement CHANGE sportif_id sportif_id INT NOT NULL, CHANGE gym_id gym_id INT NOT NULL, CHANGE mode_paiement mode_paiement DATE NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE cours ADD responsableSalle_id INT DEFAULT NULL, ADD salleId INT DEFAULT NULL, ADD placesDisponibles INT DEFAULT 20, CHANGE date_fin date_fin DATE NOT NULL, CHANGE description description TEXT DEFAULT NULL, CHANGE prix prix NUMERIC(10, 2) DEFAULT '0.00' NOT NULL, CHANGE places_disponibles coach_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
