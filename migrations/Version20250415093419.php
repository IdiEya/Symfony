 ...
 */
final class Version20250415093419 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE abonnement ADD type VARCHAR(255) NOT NULL, CHANGE mode_paiement mode_paiement VARCHAR(255) NOT NULL, CHANGE sportif_id sportif_id INT DEFAULT NULL, CHANGE gym_id gym_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
