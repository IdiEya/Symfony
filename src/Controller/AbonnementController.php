...
final class AbonnementController extends AbstractController
{
    ...
    public function index(Request $request, AbonnementRepository $abonnementRepository): Response
    {
        ...
        // Si un terme de recherche est fourni, filtrer les abonnements
        if ($searchTerm) {
            $abonnements = $abonnementRepository->searchByTerm($searchTerm);  // Vous devrez créer cette méthode dans le repository
        } else {
