 ...
 */
final class Version20250421191542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD adresse VARCHAR(255) DEFAULT NULL, DROP salle_id, DROP heure_reservation, DROP salle_nom
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE user_event_vote (user_id INT NOT NULL, event_id INT NOT NULL, vote SMALLINT NOT NULL COMMENT '1 for like, -1 for dislike', INDEX FK_USER_EVENT_VOTE_EVENT (event_id), INDEX IDX_E2BC0F23A76ED395 (user_id), PRIMARY KEY(user_id, event_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = '' 
        SQL);
        $this->addSql(<<<'SQL'
