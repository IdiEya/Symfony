 ...
 */
final class Version20250506095749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation DROP heure_reservation, DROP salle_id, DROP salle_nom, CHANGE latitude latitude DOUBLE PRECISION NOT NULL, CHANGE longitude longitude DOUBLE PRECISION NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_event_vote ADD id INT AUTO_INCREMENT NOT NULL, CHANGE vote vote SMALLINT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD heure_reservation VARCHAR(255) DEFAULT NULL, ADD salle_id INT DEFAULT NULL, ADD salle_nom VARCHAR(255) DEFAULT NULL, CHANGE latitude latitude DOUBLE PRECISION DEFAULT NULL, CHANGE longitude longitude DOUBLE PRECISION DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_event_vote MODIFY id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX `PRIMARY` ON user_event_vote
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_event_vote DROP FOREIGN KEY FK_E2BC0F2371F7E88B
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_event_vote DROP id, CHANGE vote vote SMALLINT NOT NULL COMMENT '1 for like, -1 for dislike'
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_event_vote ADD PRIMARY KEY (user_id, event_id)
        SQL);
        $this->addSql(<<<'SQL'
